...
import logoSmall from "../assets/logo-small-in-orbit.svg"
...
export function Summary() {
  return (
    <div className="py-10 max-w-[480px] px-4 mx-auto flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src={logoSmall} alt="In orbit" className="size-6" />
